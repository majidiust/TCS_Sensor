...
dist: 
	@test -d .tmp/tcs1.0.0 || mkdir -p .tmp/tcs1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tcs1.0.0/ && $(COPY_FILE) --parents base.hpp peripheral/peripheral.hpp .tmp/tcs1.0.0/ && $(COPY_FILE) --parents base.cpp main.cpp peripheral/peripheral.cpp .tmp/tcs1.0.0/ && (cd `dirname .tmp/tcs1.0.0` && $(TAR) tcs1.0.0.tar tcs1.0.0 && $(COMPRESS) tcs1.0.0.tar) && $(MOVE) `dirname .tmp/tcs1.0.0`/tcs1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tcs1.0.0
...
peripheral.o: peripheral/peripheral.cpp peripheral/peripheral.hpp \
		base.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o peripheral.o peripheral/peripheral.cpp
